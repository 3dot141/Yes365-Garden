...
代码源自 [OWASP Cross-Site Request Forgery Implementation example](https://www.owasp.org/index.php/Cross-Site_Request_Forgery_%28CSRF%29_Prevention_Cheat_Sheet#Implementation_example)
...
- CSRF 主动防御措施：Token 验证或者双重 Cookie 验证以及配合 Samesite Cookie。
