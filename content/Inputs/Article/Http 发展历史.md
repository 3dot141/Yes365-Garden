...
![](Attachments/1337b2c9e906ae665620539408cfdcc5_MD5.png)
...
![](Attachments/5301acf5f8d02b6596e8769cbd596f14_MD5.png)
...
![495](Attachments/73434203b6c8b3b1111b37487d0f0b05_MD5.png)
...
![500](Attachments/53e7c7355ea5c3b325758680b811c836_MD5.jpg)
...
- 注意：除了 HTTP/2 特定的 `"trailers"` 之外，HTTP/2 不允许使用所有 Transfer-Encoding 标头。 HTTP 2 提供了比分块传输更有效的数据流机制，并禁止使用标头。在 HTTP/2 中使用标头可能会导致特定的 `protocol error` ，因为 HTTP/2 协议禁止使用。
- 见 [RFC 7540 - Hypertext Transfer Protocol Version 2 (HTTP/2)](https://datatracker.ietf.org/doc/html/rfc7540#section-8.1)
...
- ![](Attachments/3bc7ae00aaaeee7a19c4dd1869c71f01_MD5.png)
...
![](Attachments/5007136f1567c4388b2b5049d225af55_MD5.jpg)
...
![](Attachments/7c2d5c8cec6fab7e75137caaed3e9d68_MD5.jpg)

- 服务端推送的过程：

![](Attachments/e339cb55f8da45cdf68034e7282723a7_MD5.png)
...
#### **HTTP1.1 Client talk to HTTP2 Server**

> [http2 - What if an HTTP/1.1 client talk to an HTTP/2 only server and what if an HTTP/2 client talk to an HTTP/1.1 only server? - Stack Overflow](https://stackoverflow.com/questions/36500050/what-if-an-http-1-1-client-talk-to-an-http-2-only-server-and-what-if-an-http-2-c)

按照文中的说法，http/2 和 http1.1 是相互兼容的。握手时，决定到底使用哪种方式。